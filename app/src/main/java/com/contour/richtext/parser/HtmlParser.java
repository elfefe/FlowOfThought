package com.contour.richtext.parser;
...
public class HtmlParser {
    public static Spanned fromHtml(String source, Html.ImageGetter imageGetter) {
        return HtmlCompat.fromHtml(source, HtmlCompat.FROM_HTML_MODE_LEGACY, imageGetter, new MyTagHandler());
    }

    public static Spanned fromHtml(String source) {
        return HtmlCompat.fromHtml(source, HtmlCompat.FROM_HTML_MODE_LEGACY, null, new MyTagHandler());
    }
