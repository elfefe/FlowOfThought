...
import com.contour.richtext.parser.MarkdownParser;
import com.contour.richtext.span.MyBulletSpan;
import com.contour.richtext.span.MyImgSpan;
import com.contour.richtext.span.MyQuoteSpan;
import com.contour.richtext.span.MyURLSpan;
import com.contour.richtext.util.BitmapUtil;
...
public class RichEditText extends AppCompatEditText implements TextWatcher {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        bulletColor = array.getColor(R.styleable.RichEditText_bulletColor, context.getResources().getColor(R.color.text_primary_light, null));
        bulletRadius = array.getDimensionPixelSize(R.styleable.RichEditText_bulletRadius, 15);
        bulletGapWidth = array.getDimensionPixelSize(R.styleable.RichEditText_bulletGapWidth, 10);
        ...
        quoteColor = array.getColor(R.styleable.RichEditText_quoteColor, context.getResources().getColor(R.color.primary_variant_light, null));
        quoteStripeWidth = array.getDimensionPixelSize(R.styleable.RichEditText_quoteStripeWidth, 10);
        quoteGapWidth = array.getDimensionPixelSize(R.styleable.RichEditText_quoteCapWidth, 3);
        array.recycle();
    ...
    public void fromHtml(String source) {
        Spanned s = HtmlParser.fromHtml(source, new GlideImageGeter(this, glideRequests));
